...
Despite considerable advances in metabolomics annotation, the metabolite identification remains challenging. If numerous of natural compounds are now well known, the annotation of adducts and derivatives needs to the in-depth comprehension of natural compound reactivity and transformations3. 
...
----------------------------
----------------------------
You can use the various **codes and ReadME** to better understand how to compute the putative oligomers of different oligomerization degrees based on the molecular weight of amino acids : [**Oligopeptides_matching**](https://github.com/p2m2/oligopeptides_matching.git)
